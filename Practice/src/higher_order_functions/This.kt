...
// all the numbers in the list that are divisible by 3. Start by
// creating an extension function on List that takes an lambda on Int and applies it to each item in the list.
