...
//In eBooks, counting words makes more sense than pages. Override the readPage() method
// to increase the word count by 250, the average number of words per page from typewriter days.
